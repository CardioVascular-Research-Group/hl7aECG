 ...
 *       &lt;attribute name="currency" type="{urn:hl7-org:v3}cs_Currency" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlSeeAlso({
    MOInc.class,
    SXCMMO.class,
    org.cvrgrid.hl7aecg.jaxb.beans.RTOMOPQ.Numerator.class
})
public class MO
    extends QTY
{
     ...
     *     
     */
    public void setCurrency(CsCurrency value) {
        this.currency = value;
    }
